...
`qic()` from `qicharts2` provide a simple interface for constructing faceted statistical process control charts for time series data.
...
## Case 3: Faceting hospital infections by hospital and type of infection
...
## Case 4: Prime charts for attribute data with very large sample sizes
...
qic(i, r, 
    ...
    data = nhs_accidents, 
    chart = 'p',
    main = 'Proportion of patients seen within 4 hours of attendance (P chart)',
    ylab = '',
    xlab = 'Week #')
```
...
qic(i, r, 
    ...
    data = nhs_accidents, 
    chart = 'i',
    main = 'Proportion of patients seen within 4 hours of attendance (I chart)',
    ylab = '',
    xlab = 'Week #')
```
