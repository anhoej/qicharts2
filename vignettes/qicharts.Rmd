...
Now we have data in separate categorical columns.
...
I charts are often displayed along moving range charts that show the ranges of neighboring data points.
...
Xbar charts are usually displayed along S charts displaying the sample standard deviation.
...
The conclusions from the G and the T chart are the same: The distance between deaths number 24 and 25 was unusually long. We should look for an assignable cause to explain this as this may help us find ways to reduce postoperative mortality in the future.
...
The NHS accidents dataset contains the number of emergency patients seen within 4 hours of attendance. The sample sizes are large, larger than 250,000. See `?nhs_accidents`
