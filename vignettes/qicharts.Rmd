...
```{r, eval=FALSE}
qic(month, harms > 0,      # TRUE if patient had one or more harms
    n         = days > 0,  # Always TRUE 
    data      = gtt,
    chart     = 'p',
    y.percent = TRUE,
    title     = 'Harmed patients (P chart)',
...
The conclusions from the G and the T chart are the same: Deaths number 24 and 25 are unusually far apart. We should look for an assignable cause to explain this as it may help us get ideas to reduce postoperative mortality in the future.
