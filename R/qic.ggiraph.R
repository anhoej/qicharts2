...
#' @param out.height Parameter from ggiraph::ggiraph. The width and height of the graphics region in inches. 
#'    The default values are 6 and 5 inches. This will define the aspect ratio 
#'    of the graphic as it will be used to define viewbox attribute of the SVG result.
#' @param out.width Parameter from ggiraph::ggiraph. The width and height of the graphics region in inches. 
#'    The default values are 6 and 5 inches. This will define the aspect ratio 
#'    of the graphic as it will be used to define viewbox attribute of the SVG result.
 
# @param ... Additional arguments to plot function.
#'
#' @return A \code{qic.giraph} object. Inherits from 'ggplot' and 'ggiraph'.
#'
#' @seealso \code{vignette('qic.giraph')}
#'
#' @examples
